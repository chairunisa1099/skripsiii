 ...
 <aside class="main-sidebar">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo base_url('admin/transaksi/produk') ?>"><i class="fa fa-dollar"></i> Transaksi produk</a></li>
        <li><a href="<?php echo base_url('admin/transaksi/request') ?>"><i class="fa fa-dollar"></i> Transaksi Request</a></li>
      </ul>
    </li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo base_url('admin/motif') ?>"><i class="fa fa-table"></i>Motif</a></li>
      </ul>
    </li>
