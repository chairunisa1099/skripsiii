...
<div class="flex-w flex-sb">
	<div class="w-size14 p-t-30 respon5">
		<div class="wrap-slick3 flex-sb flex-w">
			...
			<div class="slick3">
				<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/opsimotif/motif1.jpg') ?>">
					<div class="wrap-pic-w">
						<img src="<?php echo base_url('assets/upload/image/opsimotif/motif1.jpg') ?>">
					</div>
				</div>

				<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/opsimotif/motif2.jpg') ?>">
					<div class="wrap-pic-w">
						<img src="<?php echo base_url('assets/upload/image/opsimotif/motif2.jpg') ?>">
					</div>
				</div>
