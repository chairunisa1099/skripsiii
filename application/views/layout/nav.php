<?php 
// ambil data menu dr konfigurasi
...
<div class="wrap_header">
	...
	<div class="wrap_menu">
		<nav class="menu">
			<ul class="main_menu">
				...
				<li>
					<a href="<?php echo base_url()?>">Request Busana</a>
					<ul class="sub_menu">
					<li>
						<a href="<?php echo base_url('request/busanatunik/')?>">TUNIK</a>
					</li>
					<li>
						<a href="<?php echo base_url('request/busanagamis/')?>">GAMIS</a>
					</li>
	...
	<div class="header-icons">
		...
		<a href="<?php echo base_url('auth/logout') ?>" class="header-wrapicon1 dis-block">
			<i class="fa fa-sign-out"></i> Logout
		</a>


		<?php }else{ ?>
		<a href="<?php echo base_url('register') ?>" class="header-wrapicon1 dis-block">
			<img src="<?php echo base_url() ?>assets/template/images/icons/icon-header-01.png" class="header-icon1" alt="ICON">
			 Login
		</a>
		...
		<div class="header-wrapicon2">
			...
			<span class="header-icons-noti"><?php echo count($keranjang) ?>
			</span>
					...
					<li class="header-cart-item">
						...
						<div class="header-cart-item-txt">
							...
							<span class="header-cart-item-info">
								...
								?> : Rp. <?php echo number_format($keranjang_mobile['subtotal'],'0',',','.')
								?>
							</span>
						</div>
					</li>
