...
<!-- Dropify -->
<script type="text/javascript" src="<?php echo base_url('assets/bootstrap/jquery/').'jquery3.js'; ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/bootstrap/popper/').'popper.js'; ?>"></script>
